...
#include "cables/anlogicCable.hpp"
#endif
#ifdef USE_LIBFTDI
#include "cables/ch552_jtag.hpp"
#endif
#include "utils/display.hpp"
#include "protocols/jtag.hpp"
#ifdef USE_LIBFTDI
#include "cables/ftdiJtagBitbang.hpp"
#include "cables/ftdiJtagMPSSE.hpp"
#endif
#ifdef ENABLE_GOWIN_GWU2X
#include "cables/gwu2x_jtag.hpp"
#endif
#ifdef ENABLE_LIBGPIOD
#include "cables/libgpiodJtagBitbang.hpp"
#endif
#ifdef ENABLE_JETSONNANOGPIO
#include "cables/jetsonNanoJtagBitbang.hpp"
#endif
#ifdef ENABLE_JLINK
#include "cables/jlink.hpp"
#endif
#ifdef ENABLE_CMSISDAP
#include "cables/cmsisDAP.hpp"
#endif
#ifdef ENABLE_DIRTYJTAG
#include "cables/dirtyJtag.hpp"
#endif
#ifdef ENABLE_ESP_USB
#include "cables/esp_usb_jtag.hpp"
#endif
#ifdef ENABLE_CH347
#include "cables/ch347jtag.hpp"
#endif
#include "utils/part.hpp"
#ifdef ENABLE_REMOTEBITBANG
#include "cables/remoteBitbang_client.hpp"
#endif
#ifdef ENABLE_USBBLASTER
#include "cables/usbBlaster.hpp"
#endif
#ifdef ENABLE_XVC_CLIENT
#include "cables/xvc_client.hpp"
#endif
#ifdef ENABLE_XILINX_PLATFORM_CABLE_USB
#include "cables/xilinxPlatformCableUSB.hpp"
#endif
					...
					_dr_bits_after_trailing(0), _trailing_ir_bits(0)
{
	...
	case MODE_XPCU:
		...
		_jtag = new XilinxPlatformCableUSB(cable.vid, cable.pid, clkHZ,
			firmware_path, skip_probe_firmware_upload,
			xpcu_direct_xp2_firmware, verbose);
		break;
#else
